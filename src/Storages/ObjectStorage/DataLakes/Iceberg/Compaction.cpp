    ...
    for (const auto & history_record : plan.history)
    {
        ...
        auto new_snapshot = metadata_generator.generateNextMetadata(
            ...
            Iceberg::SnapshotSummary::createAppend(
                /*added_files=*/ history_record.snapshot_summary.added_files,
                /*added_records=*/ total_records_count,
                /*added_files_size=*/ history_record.snapshot_summary.added_files_size,
                /*num_partitions=*/ history_record.snapshot_summary.num_partitions),
